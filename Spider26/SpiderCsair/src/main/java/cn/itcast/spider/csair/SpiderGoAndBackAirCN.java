...
public class SpiderGoAndBackAirCN {
	...
	public static void spiderQueryaoGo() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.56.161/B2C40/query/jaxb/direct/query.ao";
		// 2.发起请求
	...
	public static void spiderHtml() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.56.161/B2C40/modules/bookingnew/main/flightSelectDirect.html?t=S&c1=CAN&c2=CTU&d1=2018-01-17&at=1&ct=0&it=0";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderJs() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.56.161/B2C40/dist/main/modules/common/requireConfig.js";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderCss() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.56.161/B2C40/dist/main/css/flight.css";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderPng() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.56.161/B2C40/dist/main/images/common.png";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderJpg() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.56.161/B2C40/dist/main/images/loadingimg.jpg";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
