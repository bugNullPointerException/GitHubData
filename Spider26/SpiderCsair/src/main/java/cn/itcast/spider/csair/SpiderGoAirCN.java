...
public class SpiderGoAirCN {
	...
	public static void spiderQueryao() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.80.81/B2C40/query/jaxb/direct/query.ao";
		// 2.发起请求
		...
		httpPost.setHeader("Remote Address", "192.168.80.81");
		httpPost.setHeader(
				"User-Agent",
	...
	public static void spiderHtml() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.80.81/B2C40/modules/bookingnew/main/flightSelectDirect.html?t=S&c1=CAN&c2=CTU&d1=2018-01-17&at=1&ct=0&it=0";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
		...
		httpPost.setHeader(
				...
				"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36");
		httpPost.setHeader("Time-Iso8601", getISO8601Timestamp());
		httpPost.setHeader("Server Address", "192.168.80.81");
		httpPost.setHeader(
				"Cookie",
	...
	public static void spiderJs() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.80.81/B2C40/dist/main/modules/common/requireConfig.js";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderCss() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.80.81/B2C40/dist/main/css/flight.css";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderPng() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.80.81/B2C40/dist/main/images/common.png";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
	...
	public static void spiderJpg() throws Exception {
		...
		// 1.指定目标网站
		String url = "http://192.168.80.81/B2C40/dist/main/images/loadingimg.jpg";
		// 2.发起请求
		HttpPost httpPost = new HttpPost(url);
		// 3. 设置请求参数
		httpPost.setHeader("Time-Local", getLocalDateTime());
