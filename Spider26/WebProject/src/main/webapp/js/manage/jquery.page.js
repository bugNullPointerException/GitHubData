	...
	var ms = {
		...
		fillHtml:function(obj,args){
			return (function(){
				...
				obj.append('<span class="page-sum">共<strong class="allPage">'+args.pageCount+'</strong>页</span>'
				+'<span class="page-go"><input type="text" placeholder="跳转至"></span><a href="javascript:;" class="page-btn">GO</a>');
			})();
		},
		//绑定事件
		bindEvent:function(obj,args){
			return (function(){
				...
				obj.on("click","a.page-btn",function(){
					var current = parseInt($(".page-go input").val());
