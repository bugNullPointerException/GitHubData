...
<html>
  <head>
  	<script type="text/javascript" src="${ctx}/js/process/newProcess.js"></script>
  ...
  <div id="myModify">
	...
	<div class="modal-footer">
		<button id="preStep" type="button" class="btn btn-primary" onclick="window.newProcess.preStep(1)">上一步</button> 
		<button id="nextStep" type="button" class="btn btn-primary" onclick="window.newProcess.nextStep(1)">下一步</button>
		<button id="finshBtn" type="button" class="btn btn-primary" onclick="window.newProcess.finsh()">完成</button> 
		<button id="outBtn" type="button" class="btn btn-default" onclick="window.newProcess.exit()">退出</button>
	</div> 
