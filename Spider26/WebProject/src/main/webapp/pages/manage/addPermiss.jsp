  ...
  <body>
	...
	<div class="modal-body" style="padding:10px 15px;">
        ...
        <table class="edit-pwd">
        	<tr>
        		<th><font class="required">*</font>权限名称</th>
        		<td><input id="name" type="text" placeholder="请输入权限名称" /></td>
        	</tr>
        	<tr>
        		<th><font class="required">*</font>权限编号</th>
	...
	<div class="content-botton-list content-list">
		...
		<button type="button" onclick="permission.newPermiss()" class="btn botton-active">确定</button>
	</div>
  </body>
